...
{          
     ...
     * 析构流函数
     */
    public function  __construct($config_value) {   
    ...
    {         
            ...
            $this->logResult2(json_decode($parameter)); 
            return $html_text;         
    }
    ...
    {                
        ...
        $this->logResult2(json_decode($_POST)); 
    ...
    function respond2()
    {
        ...
        $this->logResult2(json_decode($_GET)); 
            if($verify_result) //验证成功
            {
...
function logResult2($word='') {
    $fp = fopen(TOP_SDK_WORK_DIR."alipaylog.txt","a");
    flock($fp, LOCK_EX) ;
